...
import '../../components/ChatAppBar/chatAppBar.dart';
import '../../components/ChatSlidingSheets/EditGroupChat.dart';
import '../../components/ChatSlidingSheets/EditSingleChat.dart';
import '../../components/ChatSlidingSheets/MessageScreen.dart';
import '../../components/Pickers/picker.dart';
    ...
    return BlocListener<ChatBloc, ChatState>(
      ...
      listener: (context, state) {
        ...
        if(state[id] != null){
          ...
          if(currentChat.users.length != user.length)
            {getUserInfo();}
        }
